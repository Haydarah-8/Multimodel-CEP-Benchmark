...
**Git (repository snapshot):** Repository root `llm-safety-analysis/`. **Artifact bundle:** `87f75541116c6fde52b63caa605a84d4d30434eb` (initial commit: multimodel JSON, stats, figures, docs, lockfile). **PROVENANCE pointer commit:** `4503a9b99f895064f33cb66a6b66ef97d6f8aae6` (records the artifact hash above in this file).
